...
import { participationStatusOptions } from "./types";
...
const TournamentAddDialog = () => {
    ...
    const createMutation = useMutation({
        mutationFn: async (data: FormData) => {
            ...
            const insertData = {
                ...
                participation_status: role === "kr_admin"
                    ? data.participation_status
                    : "pending", // Managers always get pending status
    ...
    if (!canAccess("tournaments.create")) {
        return null;
    }
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input placeholder="e.g., Day 1, Quarterfinals" {...field} />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>Hoster/Organizer</FormLabel>
                                        <FormControl>
                        ...
                        {/* Info for managers - show when not admin */}
                        {role !== "kr_admin" && (
                            <div className="p-3 bg-blue-50 border border-blue-200 rounded-md text-sm text-blue-800">
                                <strong>Note:</strong> Tournament will be submitted with "Pending" status.
...
export default TournamentAddDialog;
